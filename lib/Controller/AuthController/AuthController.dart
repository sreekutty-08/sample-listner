...
class AuthController extends GetxController{
        ...
        try{
          ...
          if(response.statusCode==200){
            ...
            if (data.hasMobileNumberAndUserLevel(compinedMobile)) {
              ...
              Get.defaultDialog(title: "Incorrect", titleStyle: const TextStyle(color: Colors.red),middleText: "Please enter registered mobile number");
            }
          }
        }catch(e){
          return ("error $e");
  ...
  Future sendOtp(String phone,String otpCode)async{
        final apiUrl="https://friendlytalks.in/admin/api/v1/newotp.php?token=c97369129e36336e71096aabf2270aba&mobile=$phone&otp=$otpCode";
        try{
          final response = await http.get(Uri.parse(apiUrl));
          if(response.statusCode==200){
            return "otp sent";
