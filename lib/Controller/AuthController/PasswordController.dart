...
class PasswordController extends GetxController{
  ...
  Future fetchUserData(context,String country,String mobileNumber)async{
    final apiUrl="https://friendlytalks.in/admin/api/v1/index.php?token=c97369129e36336e71096aabf2270aba";
      ...
      if(response.statusCode==200){
        ...
        if(data.hasMobileNumberforLogin(compinedMobile)){
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(
            ...
            Get.defaultDialog(title: "Incorrect Password",middleText: "Please try again ");
          }
        }else{
          Get.defaultDialog(title: "Error",middleText: "Please enter registered mobile number");
        }
      }else{
  ...
  Future fetchListenerData(String userIdf)async{
    final apiUrl="https://friendlytalks.in/admin/api/v1/index.php?token=c97369129e36336e71096aabf2270aba&user_id=$userIdf";
